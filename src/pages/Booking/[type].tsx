  ...
  return (
    <>
      ...
      <div className="bg-sky-50">
        <header className="bg-white grid grid-cols-2 items-center justify-items-center">
          <Link href={"/"}>
        ...
        <main className="  w-[95%] mx-auto">
          ...
          <div className="flex  gap-2 mt-16">
            <form
              ...
              method="POST"
            >
              <div className="text-2xl text-center border-b bg-[#45c3d3] border-gray-300 py-4">
              ...
              <div className="p-5">
                ...
                <p className="mt-4">
                  ...
                  *Please note: Your arrival window is the block of time in
                  which the cleaners may arrive.
                </p>
